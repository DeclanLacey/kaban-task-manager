        ...
        <div className="add-task-modal">
            ...
            <div className="modal-content">
                ...
                <div className="modal-input-container">
                    ...
                    <input className="text-box-normal" type="text" value="Place current title here" placeholder="e.g. Take coffee break" />
                </div>
                <div className="modal-input-container">
                ...
                <div className="modal-input-container">
                    ...
                    <div className="input-with-x-container"> 
                        <input className="subtask-input" value="place current substask here" type="text" placeholder="e.g. Make coffee"/>
                        <img className="subtask-delete-btn-img" src="src\assets\icon-cross.svg"/>
                    </div>
                    <div className="input-with-x-container"> 
                        <input className="subtask-input" value="place current substask here" type="text" placeholder="e.g. Drink coffee & smile"/>
                        <img className="subtask-delete-btn-img" src="src\assets\icon-cross.svg"/>
                    </div> 
